...
const Products = ({ limit, title, showViewAll = true, viewAllClass = "", categoryFilter = "", priceFilter = [0, 1000] }) => {
  ...
  const FilteredProduct = Product.filter((product)=>product.title.tolowerCase().includes(SEARCH.toLowerCase()) || product.description.toLowerCase().includes(SEARCH.toLowerCase()));
    ...
    <Container>
      <div className="products-container">
        ...
        <div className="products-grid">
          {fillteredProducts && displayedProducts.map((product) => (
