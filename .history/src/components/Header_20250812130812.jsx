...
import { useTranslation } from "react-i18next"; // استيراد ال hook

const Navbar = () => {
  const { t } = useTranslation(); // استخراج دالة الترجمة
    ...
    <>
      <div className="offer-bar">
        <div className="offer-text">
          <p className="animated-offer">{t("specialOffer")}</p> {/* استدعاء الترجمة */}
        </div>
